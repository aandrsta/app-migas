        ...
        <form action="{{ route('projects.store') }}" method="POST" id="wizard-form">
            ...
            <div class="wizard-panel" id="panel-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="prediction_years" name="prediction_years" class="form-control" value="{{ old('prediction_years') }}" required min="1" max="100" placeholder="Contoh: 16 (Akan dihitung menggunakan regresi linear)" />
                </div>

                <div class="form-group">
                    <label class="form-label" for="depreciation_years">Durasi Depresiasi Investasi (Tahun)</label>
                    <input type="number" id="depreciation_years" name="depreciation_years" class="form-control" value="{{ old('depreciation_years') }}" required min="1" max="100" placeholder="Jangka waktu aset didepresiasikan (Contoh: 20)" />
                </div>
